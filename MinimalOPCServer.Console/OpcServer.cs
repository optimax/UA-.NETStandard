...
namespace MinimalOPCServer
{
    public class OpcServer : StandardServer
    {
        ...
        protected override ServerProperties LoadServerProperties()
        {
            ...
            properties.ManufacturerName = "Optimax Corporation";
            properties.ProductName = "Minimal OPC Server";
            properties.ProductUri = "optimax.com";
            properties.SoftwareVersion =
                asm.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion;
            properties.BuildNumber = asm.GetCustomAttribute<AssemblyFileVersionAttribute>().Version;
            properties.BuildDate = System.IO.File.GetLastWriteTimeUtc(asm.Location);
